...
<div class="mx-auto max-w-8xl">
    ...
    <section class="mt-8 grid gap-6 xl:grid-cols-2">
        <article class="rounded-3xl border border-[#2a2a2e] bg-surface p-6 shadow-soft">
            ...
            <div class="rounded-2xl bg-[#111117] p-4">
                <svg id="eventCreationChart" viewBox="0 0 760 320" class="h-80 w-full" role="img" aria-label="Event creation trend chart"></svg>
            </div>
        </article>
        ...
        <article class="rounded-3xl border border-[#2a2a2e] bg-surface p-6 shadow-soft">
            ...
            <div class="rounded-2xl bg-[#111117] p-4">
                <svg id="ticketsSoldChart" viewBox="0 0 760 320" class="h-80 w-full" role="img" aria-label="Total tickets sold chart"></svg>
            </div>
        </article>
    </section>
    ...
    <section class="mt-8 rounded-3xl bg-surface p-8 outline outline-[#2a2a2e] shadow-soft">
        ...
        <div class="table-scroll rounded-2xl border border-[#2a2a2e]">
            <div class="grid gap-4 border-b border-[#2a2a2e] bg-[#151419] px-6 py-4 text-sm text-secondary" style="grid-template-columns: 80px minmax(240px, 1.4fr) minmax(180px, 1fr) minmax(140px, 0.8fr) minmax(160px, 0.9fr);">
                <div>Rank</div>
                <div>Event</div>
                <div>Organizer</div>
            ...
            <?php if ($top_performing_events): ?>
                <div class="divide-y divide-[#2a2a2e] bg-surface">
                    ...
                    <div class="grid items-center gap-4 px-6 py-5 text-sm text-white" style="grid-template-columns: 80px minmax(240px, 1.4fr) minmax(180px, 1fr) minmax(140px, 0.8fr) minmax(160px, 0.9fr);">
