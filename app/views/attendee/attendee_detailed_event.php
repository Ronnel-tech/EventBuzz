        ...
        <div class="page-nav-links justify-end">
            ...
            <a href="<?= url('/attendee/ticket') ?>">
                <button class="flex justify-center align-center">
                    <svg class="icon-primary" xmlns="http://www.w3.org/2000/svg" width="28" height="28"
                        viewBox="0 0 24 24">
                        <path
                    ...
                    <div class="rounded-2xl bg-[#2a2a2e] p-6">
                        ...
                        <div class="grid gap-4 pt-5 text-secondary">
                            <div>
                                ...
                                <p class="pt-1 text-white">
                                    <?= esc(format_attendee_detail_price($starting_price, $payment_type)) ?></p>
                            </div>
                            <div>
                ...
                <div class="pt-8 text-center">
                    <?php if ($available_tickets > 0 || $payment_type === 'free'): ?>
                        <a href="<?= url('/attendee/checkout?id=' . $event['id']) ?>"
                            class="btn btn-primary inline-flex rounded-full px-10 py-3">Buy Ticket</a>
                    <?php else: ?>
                        <button type="button"
                            class="inline-flex cursor-not-allowed rounded-full bg-[#2a2a2e] px-10 py-3 text-secondary opacity-70"
                            disabled>Tickets Unavailable</button>
                    <?php endif; ?>
                </div>
            </div>
        </div>
