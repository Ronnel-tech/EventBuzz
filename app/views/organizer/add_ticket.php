            ...
            <div class="table-scroll px-4 pb-4 sm:px-6 lg:pl-15">
                ...
                <div id="ticketList" class="space-y-3 pb-8">
                    <?php if ($ticket_types): ?>
                        ...
                        <div data-ticket-row class="grid min-w-[720px] grid-cols-5 gap-4 rounded-2xl border border-[#2a2a2e] bg-[#151419] p-4 text-sm text-white">
...
<!-- ------------------------------------------------------------------------------------------------ -->
        ...
        <section class="w-full modal outline  outline-[#2a2a2e] shadow-soft ">
            ...
            <form id="ticketForm" action="<?= url('/organizer/add-ticket') ?>" method="POST" class="px-4 sm:px-6 lg:pl-10">
                <?php csrf_field() ?>
