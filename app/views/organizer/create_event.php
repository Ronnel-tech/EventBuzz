...
<body class="app-shell">
    ...
    <aside class="app-sidebar">
        ...
        <div class="app-sidebar-nav">
            <button><svg id="create_event" class="icon-primary" xmlns="http://www.w3.org/2000/svg" width="28"
        ...
        <section class="app-section">
            ...
            <form action="<?= url('/organizer/create-event') ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="w-full modal outline  outline-[#2a2a2e] shadow-soft ">
                    ...
                    <div
                        class="w-full h-50 inset-0 bg-[url('/public/assets/images/signup_bg.jpg')] 
