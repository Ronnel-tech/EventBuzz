...
<body class="app-shell">
    ...
    <aside class="app-sidebar">
        ...
        <div class="app-sidebar-nav">
            ...
            <button><svg id="ticket_type" class="icon-disabled" xmlns="http://www.w3.org/2000/svg" width="28"
            ...
            <button><svg id="payment_method" class="icon-primary" xmlns="http://www.w3.org/2000/svg" width="28"
    ...
    <div class="app-main">
        ...
        <section class="app-section">
            ...
            <section class="w-full modal outline outline-[#2a2a2e] shadow-soft ">
                ...
                <form action="<?= url('/organizer/payment-method') ?>" method="POST" enctype="multipart/form-data"
                    class="p-8">
                    <?php csrf_field() ?>
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                        <label
                            class="relative cursor-pointer rounded-2xl border border-white/10 bg-[#0d0d14] p-5 transition hover:border-white/20">
                            <input type="radio" name="payment_type" value="free" class="peer sr-only"
                        ...
                        <label
                            class="relative cursor-pointer rounded-2xl border border-white/10 bg-[#0d0d14] p-5 transition hover:border-white/20">
                            <input type="radio" name="payment_type" value="gcash" class="peer sr-only"
                                <?= $old['payment_type'] === 'gcash' ? 'checked' : '' ?> />
                            <div
                                class="absolute right-4 top-4 h-4 w-4 rounded-md border border-white/40 bg-transparent peer-checked:border-yellow-400 peer-checked:bg-yellow-400">
                            </div>
                            <div>
                    ...
                    <div class="mt-8 rounded-3xl border border-white/10 bg-[#12121a] p-5 md:p-6">
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <input type="text" name="gcash_name" value="<?= esc($old['gcash_name']) ?>"
                            ...
                            <input type="text" name="gcash_number" value="<?= esc($old['gcash_number']) ?>"
                        ...
                        <div class="mt-6">
                            ...
                            <div
                                class="w-full h-50 inset-0 bg-[url('/public/assets/images/signup_bg.jpg')] bg-cover bg-center rounded-t-3xl outline outline-[#2a2a2e] shadow-soft mb-1 flex items-center justify-center shadow-soft">

                                <input type="file" id="gcashQrInput" name="gcash_qr" accept="image/*" class="hidden">
                            ...
                            <?php if (!empty($profile['gcash_qr'])): ?>
                                <div class="mt-4">
                                    ...
                                    <img src="<?= esc($profile['gcash_qr']) ?>" alt="Saved GCash QR"
                                        class="h-40 rounded-2xl object-cover outline outline-[#2a2a2e] shadow-soft">
                                </div>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="mt-10 flex justify-end">
                        <button type="submit"
                            class="min-w-47.5 rounded-full bg-yellow-400 px-8 py-3 text-sm font-semibold text-black transition hover:brightness-110">
                            Publish
                        </button>
                    </div>
                </form>
